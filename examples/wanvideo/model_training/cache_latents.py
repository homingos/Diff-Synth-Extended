...
def main():
    ...
    parser.add_argument(
        "--num_frames", type=int, default=81, help="Number of frames per video"
    )
    ...
    parser.add_argument(
        "--verify_only", action="store_true", help="Only verify existing cache"
    )

    # Tiling arguments
    parser.add_argument(
        "--no_tiling", action="store_true", help="Disable tiled encoding"
    )
    parser.add_argument(
        "--tile_size",
        type=int,
